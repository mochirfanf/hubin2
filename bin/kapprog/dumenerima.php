            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <header class="panel-heading">
                        <label><big> DU / DI yang Menerima Berdasarkan permohonan </big></label>
                    </header>
